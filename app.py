...
def initialize_qa_system():
    try:
        ...
        prompt_template = """You are an agricultural data analyst assistant. Use the following context to answer the question.
...
def load_datasets():
    try:
        ...
        rainfall_df = pd.read_csv("data/processed/rainfall.csv")  # Adjust this path and dataset accordingly
...
def handle_complex_question(question, crops_df, rainfall_df):
    # For demo: assume parameters based on question content
    state_x = "Punjab"
    state_y = "Haryana"
